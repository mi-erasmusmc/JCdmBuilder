BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_ancestor'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_ancestor'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_class'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_class'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_relationship'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_relationship'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_synonym'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_synonym'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.domain'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.domain'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.drug_strength'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.drug_strength'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.relationship'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.relationship'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.source_to_concept_map'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.source_to_concept_map'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.vocabulary'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.vocabulary'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_ancestor'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_ancestor'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_class'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_class'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
BEGIN EXECUTE IMMEDIATE 'TRUNCATE TABLE @target_schema.concept_relationship'; EXECUTE IMMEDIATE 'DROP TABLE @target_schema.concept_relationship'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -942 THEN RAISE; END IF; END; 
